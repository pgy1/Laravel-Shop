            ...
            <div class="row">
                @if(sizeof($data['favorites'])>0)
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> 购物车</div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td width="10%">
                                    <a class="btn btn-danger fleft" href="{{ url('/favorite/pay').'/'.$favorite->fid }}">
